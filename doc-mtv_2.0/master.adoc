...
You can add providers, create network and storage mappings, and create and run a migration plan in the web console or from the CLI.

=== Migrating virtual machines in the web console
